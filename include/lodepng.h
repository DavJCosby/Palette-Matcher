...
typedef struct LodePNGInfo {
  ...
  */
    ...
    char**
        itext_transkeys; /*keyword translated to the international language - UTF-8 string*/
  ...
  */
    unsigned
        exif_defined; /* Whether exif metadata is present, that is, the PNG image has an eXIf chunk */
  ...
  */
    unsigned
        gama_defined; /* Whether a gAMA chunk is present (0 = not present, 1 = present). */
  ...
  */
    unsigned
        chrm_defined; /* Whether a cHRM chunk is present (0 = not present, 1 = present). */
  ...
  */
    unsigned
        cicp_defined; /* Whether an cICP chunk is present (0 = not present, 1 = present). */
  ...
  */
    unsigned
        mdcv_defined; /* Whether a mDCv chunk is present (0 = not present, 1 = present). */
  ...
  */
    unsigned
        clli_defined; /* Whether a cLLi chunk is present (0 = not present, 1 = present). */
    unsigned
        clli_max_cll; /* Maximum Content Light Level (MaxCLL) in cd/m^2 times 10000 */
    unsigned
        clli_max_fall; /* Maximum Frame-Average Light Level (MaxFALL) in cd/m^2 times 10000 */
...
); /*use this to clear the profile again after you filled it in*/

/*replaces if exists*/
unsigned lodepng_set_exif(
    LodePNGInfo* info,
    const unsigned char* exif,
    unsigned exif_size
);
void lodepng_clear_exif(LodePNGInfo* info
); /*use this to clear the exif metadata again after you filled it in*/
        #endif /*LODEPNG_COMPILE_ANCILLARY_CHUNKS*/
